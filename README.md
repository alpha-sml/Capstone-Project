Based on your request to indicate that this project is a portfolio template capstone project for your first semester, here's an updated `README.md` for your GitHub repository:
